...
console.log(neuArray);
/////////////////////////
/* Aufgabe lvl 1.9 splice() Delet
////////////////////////



/* Zum Entfernen von Elementen: array.splice (position Index, Anzahl der Elemente). */
let array3 = [
...
/* Für das Hinzufügen von Elementen: array.splice ( postion/Index, Anzahl der Elemente vom /bis, Element/what want we add).
 */

var array = [ "imageTeilnehmer000supercode.jpg", "imageTeilnehmer001supercode.jpg" ];

 array.splice(array.length, 0,"imageTeilnehmer008supercode", "imageTeilnehmer009supercode", "imageTeilnehmer0010supercode" );
...
for (let i = 14; i <= 19; i++) {
 ...
 array.splice(array.length,0,"imge"+i+ ".com");
